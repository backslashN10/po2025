...
//             Clutch sprzeglo = createClutch();
//             Gearbox skrzynia = createGearbox(sprzeglo);
//             Silnik silnik = createEngine();

//             Position start = new Position(0, 0);
//             Car nowySamochod = new Car(nrRejestracji, model, vMax, skrzynia, silnik, start);
...
//     private Clutch createClutch() {
//         if (clutch1Radio.isSelected()) {
//             return new Clutch("sprzeglo1", 200, 757);
//         } else if (clutch2Radio.isSelected()) {
//             return new Clutch("sprzeglo2", 300, 1200);
//         } else if (clutch3Radio.isSelected()) {
//             return new Clutch("sprzeglo3", 250, 900);
//         } else {
...
//             return new Clutch(nazwa, cena, waga);
//         }
//     }

//     private Gearbox createGearbox(Clutch sprzeglo) {
//         if (gearbox1Radio.isSelected()) {
//             return new Gearbox("skrzynia1", 100, 212, 2, sprzeglo,
//                     new double[]{800, 1000, 3000});
//         } else if (gearbox2Radio.isSelected()) {
//             return new Gearbox("skrzynia2", 150, 350, 5, sprzeglo,
//                     new double[]{800, 1200, 2000, 3500, 5000, 7000});
//         } else if (gearbox3Radio.isSelected()) {
//             return new Gearbox("skrzynia3", 120, 280, 6, sprzeglo,
...
//             return new Gearbox(nazwa, cena, waga, liczbaBiegow, sprzeglo, przelozenia);
//         }
//     }
